...
import { deleteFormById, getFormById } from "@/Redux/slices/formSlice";
      ...
      <main className="container gradient-bg">
        ...
        <div className="flex items-center justify-between gap-6 sm:flex-nowrap flex-wrap">
          <div className="flex items-center gap-3  sm:flex-nowrap flex-wrap">
            <div className="bg-[#26A8F1] h-14 w-14 rounded-full flex items-center justify-center shrink-0">
              <FormIcon />
            </div>
            <AuthHeadings
          ...
          <div className="flex itemx-center gap-3 flex-wrap">
            <button
              onClick={() => router.push(`/all-forms/${formId}/edit`)}
